<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <aside class="entry-meta">
        ...
        <?php if ( option::is_on( 'display_comments' ) ) { ?><?php comments_popup_link( __('0 comments', 'wpzoom'), __('1 comment', 'wpzoom'), __('% comments', 'wpzoom'), '', __('Comments are Disabled', 'wpzoom')); } ?>
