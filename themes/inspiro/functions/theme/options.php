...
"id1" => array(
    ...
    array(
      ...
      array(
        ...
        array(
            "name" => "Display Next/Previous Posts",
            "id" => "post_nextprev",
            "std" => "on",
            "type" => "checkbox"
        ),
...
"id2" => array(
    ...
    array("name"  => "Enable Featured Image Fallback for Background Video?",
          "desc"  => "Show featured on devices that do not support background video or before video is loaded.",
          "id"    => "slideshow_video_fallback",
          "std"   => "on",
          "type"  => "checkbox",
          "js"    => true),
...
"id5" => array(
    ...
    array("name"  => "Button Border Color",
           "id"   => "button_top_border_color",
           "type" => "color",
           "selector" => ".slides > li .slide_button a",
           "attr" => "border-color"),

    array("name"  => "Button Text Color",
           "id"   => "button_top_color",
           "type" => "color",
           "selector" => ".slides > li .slide_button a",
           "attr" => "color"),
    ...
    array("name"  => "Button Background Color",
           "id"   => "button_top_bg_color",
           "type" => "color",
           "selector" => ".slides > li .slide_button a",
           "attr" => "background-color"),


    array("name"  => "Button Border Color (Hover)",
           "id"   => "button_top_border_color_hover",
           "type" => "color",
           "selector" => ".slides > li .slide_button a:hover, .slides > li .slide_button a:focus",
           "attr" => "border-color"),

    array("name"  => "Button Text Color (Hover)",
           "id"   => "button_top_color_hover",
           "type" => "color",
           "selector" => ".slides > li .slide_button a:hover, .slides > li .slide_button a:focus",
           "attr" => "color"),

    array("name"  => "Button Background Color (Hover)",
           "id"   => "button_top_bg_color_hover",
           "type" => "color",
           "selector" => ".slides > li .slide_button a:hover, .slides > li .slide_button a:focus",
           "attr" => "background-color"),
