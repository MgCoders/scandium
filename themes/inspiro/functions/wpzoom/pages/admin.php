     ...
     <div class="head_meta">
        <div id="zoomInfo">
            <ul>
                ...
                <?php if ( $has_access ): ?>
                    <li class="demo-import" id="zoomInfo-demoimport"><a href="#<?php echo $link_href ?>" id="wpz-demo-content-icon" title="<?php echo __('Import Demo Content', 'wpzoom') ?>"><i class="fa fa-download"></i></a></li>
                <?php endif ?>
            </ul>
        </div>
